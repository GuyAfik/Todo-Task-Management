...
func (c *helloWorldServiceClient) Hello(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	out := new(HelloWorldResponse)
	err := c.cc.Invoke(ctx, "/example.helloworld.HelloWorldService/hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloWorldServiceServer) Hello(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error) {
...
func _HelloWorldService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.helloworld.HelloWorldService/hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServiceServer).Hello(ctx, req.(*HelloWorldRequest))
	}
...
var HelloWorldService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.helloworld.HelloWorldService",
