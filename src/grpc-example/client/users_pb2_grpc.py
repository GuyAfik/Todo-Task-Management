...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.scoreAvg = channel.unary_unary(
                '/example.users.UserService/scoreAvg',
...
class UserServiceServicer(object):
    ...
    def scoreAvg(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'scoreAvg': grpc.unary_unary_rpc_method_handler(
                    servicer.scoreAvg,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'example.users.UserService', rpc_method_handlers)
...
class UserService(object):
    ...
    def scoreAvg(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/example.users.UserService/scoreAvg',
